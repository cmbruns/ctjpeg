...
libjpeg_lib = cdll.LoadLibrary("jpeg62.dll")
JPEG_LIB_VERSION = 62
...
jpeg_destination_mgr._fields_ = (
        ...
        ("free_in_buffer", c_size_t),  # # of byte spaces remaining in buffer
...
jpeg_source_mgr._fields_ = (
        ...
        ("bytes_in_buffer", c_size_t),  # # of bytes remaining in buffer
...
jpeg_memory_mgr._fields_ = (
        # Method pointers
        ("alloc_small", CFUNCTYPE(c_void_p, j_common_ptr, c_int, c_size_t)),

        ("alloc_large", CFUNCTYPE(c_void_p, j_common_ptr, c_int, c_size_t)),
...
jpeg_destroy_compress.argtypes = [
    j_compress_ptr,
]
...
jpeg_stdio_dest = libjpeg_lib.jpeg_stdio_dest
jpeg_stdio_dest.restype = None
jpeg_stdio_dest.argtypes = [
    j_compress_ptr,
    POINTER(FILE),
]
...
jpeg_mem_dest.restype = None
jpeg_mem_dest.argtypes = [
    j_compress_ptr,
...
jpeg_set_colorspace.restype = None
jpeg_set_colorspace.argtypes = [
    j_compress_ptr,
    J_COLOR_SPACE,
]
...
jpeg_start_compress.restype = None
jpeg_start_compress.argtypes = [
    j_compress_ptr,
    boolean,
]
...
jpeg12_write_scanlines.argtypes = [
    j_compress_ptr,
    J12SAMPARRAY,
    JDIMENSION,
]
...
jpeg_write_raw_data.restype = JDIMENSION
jpeg_write_raw_data.argtypes = [
    j_compress_ptr,
    JSAMPIMAGE,
    JDIMENSION,
]
...
jpeg_write_marker.restype = None
jpeg_write_marker.argtypes = [
    j_compress_ptr,
    c_int,
    POINTER(JOCTET),
    c_uint,
...
jpeg_write_icc_profile.restype = None
jpeg_write_icc_profile.argtypes = [
    j_compress_ptr,
    POINTER(JOCTET),
    c_uint,
]
...
jpeg16_read_scanlines.argtypes = [
    j_decompress_ptr,
    J16SAMPARRAY,
    JDIMENSION,
]
...
jpeg_read_raw_data.restype = JDIMENSION
jpeg_read_raw_data.argtypes = [
    j_decompress_ptr,
    JSAMPIMAGE,
    JDIMENSION,
]
...
jpeg_save_markers.restype = None
jpeg_save_markers.argtypes = [
    j_decompress_ptr,
    c_int,
    c_uint,
]
...
jpeg_set_marker_processor.argtypes = [
    j_decompress_ptr,
    c_int,
...
jpeg_write_coefficients.argtypes = [
    j_compress_ptr,
...
# reuse it, call this:
jpeg_abort_compress = libjpeg_lib.jpeg_abort_compress
jpeg_abort_compress.restype = None
jpeg_abort_compress.argtypes = [
    j_compress_ptr,
]
...
jpeg_abort = libjpeg_lib.jpeg_abort
jpeg_abort.restype = None
jpeg_abort.argtypes = [
    j_common_ptr,
]
...
jpeg_resync_to_restart.argtypes = [
    j_decompress_ptr,
    c_int,
]
...
jpeg_read_icc_profile.argtypes = [
    j_decompress_ptr,
